...
# -- 1)Title --
title_label = ttk.Label(root, text=" Title ",background="#101010",borderwidth=4, relief= "sunken", foreground ="#66FFB2" , font=("TkDefaultFont",16))
...
# -- 2)Author --
author_label = ttk.Label(root, text=" Author ",background="#101010",borderwidth=4, relief= "sunken", foreground ="#66FFB2" ,font=("TkDefaultFont",16))
...
# -- 3)ISBN --
isbn_label = ttk.Label(root, text=" ISBN ",background="#101010",borderwidth=4, relief= "sunken", foreground ="#66FFB2" , font=("TkDefaultFont",16))
